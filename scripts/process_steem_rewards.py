...
def rpc(method, params=None):
    ...
    req = Request(RPC, data=payload, headers={"Content-Type": "application/json", "User-Agent": "SteemFlags-GitHubAction/1.0"})
...
def main():
    ...
    end_block = min(head, last_block + BATCH_SIZE)
    blocks = batch_get_ops(last_block + 1, end_block)
