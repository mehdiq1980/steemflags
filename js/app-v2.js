...
async function start(){
 ...
 function applyEnglishBrandTitles(lang){if(lang!=='en')return;const title=document.querySelector('.homeTitle');if(title)title.innerHTML='Guess the Flags<br>&amp; Earn $STEEM';const boardTitle=document.querySelector('#leaderboardSection h2');if(boardTitle)boardTitle.textContent='Steem Flags Leaderboard'}
