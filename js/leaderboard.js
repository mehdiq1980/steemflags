...
async function readLeaderboard(){
  // The deployed Cloudflare Worker (cloudflare/wrangler.toml -> worker.js)
  // exposes leaderboard data at /api/leaderboard.
  ...
  if(!response.ok||!data?.success||!Array.isArray(data.accounts))throw Error(`LEADERBOARD_${response.status}_${data?.error||'INVALID_DATA'}`);
