const DICTIONARIES = {
  en: {
    ...
    gameComplete: 'Game complete!', gamesLabel: 'Games', accuracyLabel: 'Accuracy', bestStreakLabel: 'Best streak'
  },
  fa: {
    ...
    gameComplete: 'بازی تمام شد!', gamesLabel: 'بازی‌ها', accuracyLabel: 'دقت', bestStreakLabel: 'بهترین روند'
  },
  es: {
    ...
    gameComplete: '¡Juego completado!', gamesLabel: 'Partidas', accuracyLabel: 'Precisión', bestStreakLabel: 'Mejor racha'
  }
};
