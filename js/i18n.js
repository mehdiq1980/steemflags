const DICTIONARIES = {
  en: {
    loginTitle: 'Steem Flags', loginPrompt: 'Enter your Steem username', login: 'Login',
  ...
  fa: {
    loginTitle: 'استیم فلگز', loginPrompt: 'نام کاربری استیم خود را وارد کنید', login: 'ورود',
  ...
  es: {
    loginTitle: 'Steem Flags', loginPrompt: 'Introduce tu nombre de usuario de Steem', login: 'Iniciar sesión',
